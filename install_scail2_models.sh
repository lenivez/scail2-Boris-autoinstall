...
echo "=== Text Encoder umt5 fp8 (~6.7GB) ==="
...
if [ ! -f "/workspace/ComfyUI/models/loras/Wan22/wan2.1_SCAIL_2_DPO_lora_bf16.safetensors" ]; then
    ...
    mv /workspace/ComfyUI/models/loras/Wan22/loras/wan2.1_SCAIL_2_DPO_lora_bf16.safetensors \
       /workspace/ComfyUI/models/loras/Wan22/wan2.1_SCAIL_2_DPO_lora_bf16.safetensors
    rmdir /workspace/ComfyUI/models/loras/Wan22/loras 2>/dev/null || true
else
    echo "  уже есть, пропускаем"
fi

echo "=== LoRA: LightX2V rank256 bf16 (2.92GB) ==="
